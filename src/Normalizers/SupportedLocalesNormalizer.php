...
class SupportedLocalesNormalizer implements GroupAttributeNormalizerInterface
{
    ...
    {
        if (! array_key_exists('supported_locales', $attributes)) {
        ...
        return Arr::mapWithKeys(
            ...
            function ($locale, $code) use ($fallbackLocales) {
                ...
                // Throw an exception indicating that the provided locale is not supported (not configured in the supported_locales config attribute).
